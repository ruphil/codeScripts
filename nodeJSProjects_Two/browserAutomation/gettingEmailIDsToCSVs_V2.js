...
async function startMakingEMailsCSV() {
    ...
    let keyWordRadioSelector = '#optlist_0';
    let keyWordTextSelector = '#keytext';
    let searchButton = '#search';
    let nextButton = '#Button1';

    await page.waitForTimeout(keyWordRadioSelector);
    await page.waitForTimeout(1000);
    await page.click(keyWordRadioSelector);
    await page.waitForTimeout(2000);

    await page.waitForTimeout(keyWordTextSelector);
    await page.waitForTimeout(3000);
    await page.$eval(keyWordTextSelector, el => el.value = 'a');
    await page.waitForTimeout(2000);
